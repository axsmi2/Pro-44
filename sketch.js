...
var astroid, fireball, shark, sharkImg, eagle;
var invisibleG;
var game1Obstacle;
var gameState= "intro";
var gameChoice;
...
var game2ObstacleGroup;
var enemy1Obstacle, enemy2Obstacle, enemy3Obstacle;
...
enemy1Obstacle= new Group();
enemy2Obstacle= new Group();
enemy3Obstacle= new Group();
...
function game2Obstacle(){
    ...
    function game3Obstacle(){
        if(frameCount%80==0){
              ...
              game3Obstacles.y=Math.round(random(height/2-50,height/2+20));
        ...
        function enemyObstacle(){
            if(frameCount%80==0){
                  Obstacles=createSprite(width/2+500,height/2+100);
                  Obstacles.velocityX=-3;
                  Obstacles.y=Math.round(random(height/2-50,height/2+20));
                  var num=Math.round(random(1,6));
                 
                  switch(num){
                      case 1: Obstacles.addImage(w1Img);       
                      break;
                      case 2: Obstacles.addImage(w2Img);
                      break;
                      case 3: Obstacles.addImage(w3Img);
                      break;
                      case 4: Obstacles.addImage(w6Img);
                      break;
                      case 5: Obstacles.addImage(w7Img);
                      break;
                      case 6: Obstacles.addImage(w8Img);
                      break;
                  }
                 Obstacles.scale=0.1;
